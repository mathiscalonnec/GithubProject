    ...
    Item (item) {
        return (
          <View style={styles.listItem}>
            ...
            <TouchableOpacity style={{height:50,width:50, justifyContent:"center", alignItems:"center"}} onPress={() => this.props.navigation.navigate("Repository", {data:item, fav:false})}>
